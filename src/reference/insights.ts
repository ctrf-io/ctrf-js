 ...
 *
 * @param report - The current report to enrich
 * @param historicalReports - Array of historical reports for comparison
 * @param options - Insights options (baseline is the baseline report)
 * @returns The report with insights added
 *
 * @example
 * ```typescript
 * // Basic usage
