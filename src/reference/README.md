...
This is the **reference implementation** of the Common Test Report Format (CTRF) specification in TypeScript. It is designed to serve as the canonical implementation for standards body submission and as a guide for implementing CTRF in other programming languages.
