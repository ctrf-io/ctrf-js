...
[CTRF](../../README.md) / [index](../README.md) / InsightsMetric
...
Use types from `ctrf` namespace (e.g., `ctrf.CTRFReport`, `ctrf.Test`) or direct imports instead. Will be removed in v1.
